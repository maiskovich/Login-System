 ...
 *   https://datatables.net/download/#bs/jqc-1.11.3,dt-1.10.9,af-2.0.0,r-1.0.7,rr-1.0.0
 *
 * Included libraries:
 *   jQuery compat 1.11.3, DataTables 1.10.9, AutoFill 2.0.0, Responsive 1.0.7, RowReorder 1.0.0
 */
...
(/** @lends <global> */function( $ ) {
	...
	DataTable = function( options )
	{
		...
		this.each(function() {
			...
			/*oLanguage.sUrl='/public/DataTables/spanish.json';*/
			if ( oLanguage.sUrl !== "" )
			{
...
jQuery.fn.dataTable.ext.builder = "bs\/jqc-1.11.3,dt-1.10.9,af-2.0.0,r-1.0.7,rr-1.0.0";
